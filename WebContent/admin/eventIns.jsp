...
<%@page import="com.model.eventInsModel"%>
    ...
    <div class="page-container">
                            ...
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="eventIns.jsp"><i class="fa fa-heart"></i>&nbsp;&nbsp;Wedding & Events</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Insert New Wedding & Event Service#</h1></u></center>
                <div class="row">
                 	<%
	                 	eventInsModel dao=new eventInsModel();
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                   ...
                                   <form method="post" name="frm" action="../eventInst">
