<%@page import="com.bean.healthSpBean"%>
<%@page import="com.model.HealthSpModel"%>
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="healthSP.jsp"><i class="fa fa-user-md"></i>&nbsp;&nbsp;Health & Fitness</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="main-content-inner">
                  <center><u> <h1>#Health & Fitness#</h1></u></center>

                <div class="row">
                 	<%
                 	HealthSpModel dao=new HealthSpModel();
               		List<healthSpBean> list=dao.getData();
                 	%>
                    <!-- Primary table start -->
                                ...
                                <form method="post" name="app">
                                    <table id="dataTable2" class="text-center">
										...
										%>
												...
												<td style="text-align:center"> 
													<a href="../delHealthSp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>" class="btn btn-sm btn-danger">
													...
													<a class="btn btn-primary btn-sm" href="healthSpEdit.jsp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>">
