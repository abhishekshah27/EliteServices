<%@page import="com.bean.HomecareBean"%>
<%@page import="com.model.HomecareModel"%>
    ...
    <div class="page-container">
                            ...
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    <li  class=active><a href="homecare.jsp"><i class="fa fa-home"></i>&nbsp;&nbsp;Home Care & design</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="row">
                 	<%
						HomecareModel dao=new HomecareModel();
					   	List<HomecareBean> list=dao.getData();
					%>
                    <!-- Primary table start -->
                                    ...
                                    <table id="dataTable2" class="text-center">
										...
										%>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
												<a href="../delHomecare?id=<%=obj.getId()%>" class="btn btn-sm btn-danger">
												<i class="glyphicon glyphicon-trash icon-white"></i>
												Delete
												</a>
												&nbsp;&nbsp;
												<a class="btn btn-primary btn-sm" href="homecareEdit.jsp?id=<%=obj.getId()%>&se_name=<%=obj.getSe_name()%>&se_sub_name=<%=obj.getSe_sub_name()%>">
