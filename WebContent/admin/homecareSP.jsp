<%@page import="com.bean.homecareSpBean"%>
<%@page import="com.model.HomecareSpModel"%>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="display.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Users</a></li>
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    <li class=active><a href="homecareSP.jsp"><i class="fa fa-home"></i>&nbsp;&nbsp;Home Care & design</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="main-content-inner">
                  <center><u> <h1>#Home Care & design#</h1></u></center>

                <div class="row">
                 	<%
	                 	HomecareSpModel dao=new HomecareSpModel();
	               		List<homecareSpBean> list=dao.getData();
                 	%>
                    <!-- Primary table start -->
                                ...
                                <form method="post" name="app">
                                    <table id="dataTable2" class="text-center">
										...
										%>
												...
												<td style="text-align:center"> 
													<a href="../delHomecareSp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>" class="btn btn-sm btn-danger">
													...
													<a class="btn btn-primary btn-sm" href="homecareSpEdit.jsp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>">
