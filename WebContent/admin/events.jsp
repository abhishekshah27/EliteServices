    ...
    <div class="page-container">
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="events.jsp"><i class="fa fa-heart"></i>&nbsp;&nbsp;Wedding & Events</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="row">
                 	<%
                 	EventModel dao=new EventModel();
               		List<EventBean> list=dao.getData();
					%>
                    <!-- Primary table start -->
                                    ...
                                    <table id="dataTable2" class="text-center">
										...
										%>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
												<a href="../delEvent?id=<%=obj.getId()%>" class="btn btn-sm btn-danger">
												<i class="glyphicon glyphicon-trash icon-white"></i>
												Delete
												</a>
												
												<a class="btn btn-primary btn-sm" href="eventEdit.jsp?id=<%=obj.getId()%>&se_name=<%=obj.getSe_name()%>&se_sub_name=<%=obj.getSe_sub_name()%>">
