...
<%@page import="com.model.homecareInsModel"%>
    ...
    <div class="page-container">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li class=active>
                                ...
                                <ul class="collapse">
                                    <li class=active><a href="homecareIns.jsp"><i class="fa fa-home"></i>&nbsp;&nbsp;Home Care & design</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Insert New Home Care & Design Service#</h1></u></center>
                <div class="row">
                 	<%
						homecareInsModel dao=new homecareInsModel();
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                   ...
                                   <form method="post" name="frm" action="../homecareInst">
