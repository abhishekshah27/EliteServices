...
<%@page import="com.model.businessInsModel"%>
    ...
    <div class="page-container">
                            ...
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="businessIns.jsp"><i class="fa fa-legal"></i>&nbsp;&nbsp;Business Services</a></li>
                                </ul>
                            </li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Insert New Business Service#</h1></u></center>
                <div class="row">
                 	<%

	                	businessInsModel dao=new businessInsModel();
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                   ...
                                   <form method="post" name="frm" action="../businessInst">
