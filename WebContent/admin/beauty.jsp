    ...
    <div class="page-container">
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="beauty.jsp"><i class="fa fa-female"></i>&nbsp;&nbsp;Beauty & Spa</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="row">
                 	<%
                 	BeautyModel dao=new BeautyModel();
                                    ...
                                    <table id="dataTable2" class="text-center">
										...
										%>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
												<a href="../delBeauty?id=<%=obj.getId()%>" class="btn btn-sm btn-danger">
												<i class="glyphicon glyphicon-trash icon-white"></i>
												Delete
												</a>
												
												<a class="btn btn-primary btn-sm" href="beautyEdit.jsp?id=<%=obj.getId()%>&se_name=<%=obj.getSe_name()%>&se_sub_name=<%=obj.getSe_sub_name()%>">
