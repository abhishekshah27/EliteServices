...
<%@page import="com.model.RegSPModel"%>
<!doctype html>
	...
	<%--<%@ include file="sidebar.jsp" --%> 
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class=active><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Service Provider Registrations#</h1></u></center>
                <div class="row">
                
                 <%
				  		RegSPModel dao=new RegSPModel();
				  		List<serviceproviderBean> list=dao.getData();
				  %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2" class="text-center">
                                        ...
                                        <%
                                        	for(serviceproviderBean obj:list)
                                    		{
                                    		%>
