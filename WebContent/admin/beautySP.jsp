<%@page import="com.bean.beautySpBean"%>
<%@page import="com.model.BeautySpModel"%>
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="beautySP.jsp"><i class="fa fa-female"></i>&nbsp;&nbsp;Beauty & Spa</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="main-content-inner">
                  <center><u> <h1>#Beauty & Spa#</h1></u></center>

                <div class="row">
                 	<%
                	BeautySpModel dao=new BeautySpModel();
               		List<beautySpBean> list=dao.getData();
                                ...
                                <form method="post" name="app">
                                    <table id="dataTable2" class="text-center">
										...
										%>
												...
												<td style="text-align:center"> 
													<a href="../delBeautySp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>" class="btn btn-sm btn-danger">
													...
													<a class="btn btn-primary btn-sm" href="beautySpEdit.jsp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>">
