<%@page import="com.bean.eventSpBean"%>
<%@page import="com.model.EventSpModel"%>
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="eventSP.jsp"><i class="fa fa-heart"></i>&nbsp;&nbsp;Wedding & Events</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="main-content-inner">
                  <center><u> <h1>#Wedding & Events#</h1></u></center>

                <div class="row">
                 	<%
	                 	EventSpModel dao=new EventSpModel();
	               		List<eventSpBean> list=dao.getData();
                 	%>
                    <!-- Primary table start -->
                                ...
                                <form method="post" name="app">
                                    <table id="dataTable2" class="text-center">
										...
										%>
												...
												<td style="text-align:center"> 
													<a href="../delEventSp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>" class="btn btn-sm btn-danger">
													...
													<a class="btn btn-primary btn-sm" href="eventSpEdit.jsp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>">
