...
<%@page import="com.model.repairInsModel"%>
    ...
    <div class="page-container">
                            ...
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="repairIns.jsp"><i class="fa fa-laptop"></i>&nbsp;Repairs & Maintenance</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Insert New Repair & Maintenance Service#</h1></u></center>
                <div class="row">
                 	<%
		                 	repairInsModel dao=new repairInsModel();
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                   ...
                                   <form method="post" name="frm" action="../repairInst">
