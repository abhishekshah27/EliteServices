<%@page import="com.bean.repairSpBean"%>
<%@page import="com.model.RepairSpModel"%>
    ...
    <div class="page-container">
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="repairSP.jsp"><i class="fa fa-laptop"></i>&nbsp;Repairs & Maintenance</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Repairs & Maintenance#</h1></u></center>
                <div class="row">
                 	<%
                 	RepairSpModel dao=new RepairSpModel();
               		List<repairSpBean> list=dao.getData();
					%>
                    <!-- Primary table start -->
                                    ...
                                    <table id="dataTable2" class="text-center">
                                        <thead class="text-capitalize">
											...
											%>
												...
												<td style="text-align:center"> 
													<a href="../delRepairSp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>" class="btn btn-sm btn-danger">
													...
													<a class="btn btn-primary btn-sm" href="repairSpEdit.jsp?id=<%=obj.getSe_id()%>&name=<%=obj.getId()%>">
