...
<%@page import="com.model.healthInsModel"%>
    ...
    <div class="page-container">
                            ...
                            <li><a href="displaySP.jsp"><i class="fa fa-list"></i>&nbsp;&nbsp;All Service Providers</a></li>
                             ...
                             <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="healthIns.jsp"><i class="fa fa-user-md"></i>&nbsp;&nbsp;Health & Fitness</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#Insert New Health & Fitness Service#</h1></u></center>
                <div class="row">
                 	<%
	                 	healthInsModel dao=new healthInsModel();
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                   ...
                                   <form method="post" name="frm" action="../healthInst">
