<%@page import="com.bean.HealthBean"%>
<%@page import="com.model.HealthModel"%>
    ...
    <div class="page-container">
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="health.jsp"><i class="fa fa-user-md"></i>&nbsp;&nbsp;Health & Fitness</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="row">
                 	<%
                 	HealthModel dao=new HealthModel();
               		List<HealthBean> list=dao.getData();
					%>
                    <!-- Primary table start -->
                                    ...
                                    <table id="dataTable2" class="text-center">
										...
										%>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
												<a href="../delHealth?id=<%=obj.getId()%>" class="btn btn-sm btn-danger">
												<i class="glyphicon glyphicon-trash icon-white"></i>
												Delete
												</a>
												
												<a class="btn btn-primary btn-sm" href="healthEdit.jsp?id=<%=obj.getId()%>&se_name=<%=obj.getSe_name()%>&se_sub_name=<%=obj.getSe_sub_name()%>">
