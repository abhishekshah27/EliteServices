<%@page import="com.bean.RepairBean"%>
<%@page import="com.model.RepairModel"%>
    ...
    <div class="page-container">
                             ...
                             <li>
                              ...
                              <li class=active>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class=active><a href="repair.jsp"><i class="fa fa-laptop"></i>&nbsp;Repairs & Maintenance</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <div class="row">
                 	<%
	                 	RepairModel dao=new RepairModel();
	               		List<RepairBean> list=dao.getData();
					%>
                    <!-- Primary table start -->
                                    ...
                                    <table id="dataTable2" class="text-center">
										...
										%>
                                            ...
                                            <tr>
                                            	...
                                            	<td>
												<a href="../delRepair?id=<%=obj.getId()%>" class="btn btn-sm btn-danger">
												<i class="glyphicon glyphicon-trash icon-white"></i>
												Delete
												</a>
												
												<a class="btn btn-primary btn-sm" href="repairEdit.jsp?id=<%=obj.getId()%>&se_name=<%=obj.getSe_name()%>&se_sub_name=<%=obj.getSe_sub_name()%>">
