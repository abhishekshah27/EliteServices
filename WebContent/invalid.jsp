...
<%@ include file="header.jsp" %>
	...
	<script src='validation/sweetalert2.all.js'></script>
	<script src='validation/jqueryalert.min.js'></script>
				<script>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <a href="home_care.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  ...
  <div class="card-body">
    ...
    <a href="repair.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  ...
  <div class="card-body">
   ...
   <!--  <p class="card-text">Some quick example text to build on the Elite Services and make up the bulk of the card's content.</p> -->
    <a href="events.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <!-- <p class="card-text">Some quick example text to build on the Elite Services and make up the bulk of the card's content.</p> -->
    <a href="health.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  ...
  <div class="card-body">
   ...
   <!--  <p class="card-text">Some quick example text to build on the Elite Services and make up the bulk of the card's content.</p> -->
    <a href="beauty.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  ...
  <div class="card-body">
    ...
    <!-- <p class="card-text">Some quick example text to build on the Elite Services and make up the bulk of the card's content.</p> -->
    <a href="business.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
