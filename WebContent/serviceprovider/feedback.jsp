    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" class=active id="menu">
                            ...
                            <li><a href="display.jsp"><i class="ti-receipt"></i>&nbsp;&nbsp;Service Requests</a></li>
                            <li class=active><a href="feedback.jsp"><i class="ti-comment"></i>&nbsp;&nbsp;Feedbacks</a></li>
        ...
        <!-- main content area start -->
            <div class="main-content">
                ...
                <center><u> <h1>#User Feedbacks#</h1></u></center>
                <div class="row">
