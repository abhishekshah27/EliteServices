...
public class RepairModel {
	...
	public List<RepairBean> getData(){
		...
		try
		{
			...
			String sql="select services.se_sub_id,services.se_sub_name,repair_master.se_name from services join repair_master where services.se_id=repair_master.se_id";
