...
public class BusinessModel {
	...
	public List<BusinessBean> getData(){
		...
		try
		{
			...
			String sql="select services.se_sub_id,services.se_sub_name,business_master.se_name from services join business_master where services.se_id=business_master.se_id";
