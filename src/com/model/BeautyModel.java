...
public class BeautyModel {
	public List<BeautyBean> getData(){
		...
		try
		{
			...
			String sql="select services.se_sub_id,services.se_sub_name,beauty_master.se_name from services join beauty_master where services.se_id=beauty_master.se_id";
